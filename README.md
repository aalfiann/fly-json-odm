...
<script src="https://cdn.jsdelivr.net/npm/fly-json-odm@1.14/dist/flyjson.min.js"></script>

<!-- Get a specific version -->
<!-- Recommended for production sites! -->
<script src="https://cdn.jsdelivr.net/npm/fly-json-odm@1.14.0/dist/flyjson.min.js"></script>
```
